...
- **NLP-Powered Request Analysis**: Analyze and prioritize patient requests using **Olama**, **TensorFlow**, and **NLP**.
...
- **Enhanced Patient Care**: Faster and more efficient nurse-patient communication.
...
- Admins can view pending approvals, nurse activity, and system health.
...
### AI & NLP
- **Olama** and **TensorFlow** for NLP-powered request analysis
...
```bash
git clone https://github.com/mohd-idrees/Voice-Based-Patient-Call-System.git
...
```bash
git fork https://github.com/mohd-idrees/Voice-Based-Patient-Call-System.git
```
